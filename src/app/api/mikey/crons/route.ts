...
const CRON_REGISTRY: CronItem[] = [
  ...
  // ========== LOCAL MAC — launchd plists (fleet/agent services) ==========
  {
    ...
    name: "ACMI Bus Relay (degraded)",
    schedule: "StartInterval 300s",
    command: "/opt/homebrew/Cellar/node/26.0.0/bin/node /Users/michaelshaw/Projects/open-design/apps/daemon/dist/cli.js",
    logPath: "/Users/michaelshaw/.clawd/logs/acmi-bus-relay.log",
    scriptPath: "/Users/michaelshaw/Library/LaunchAgents/com.acmi.bus-relay.plist",
    description: "Relay that polls acmi:bus:events and fans out to Mattermost. Currently degraded: POST /emit returns 403 (bridge at :8081 is Upstash translator). Bypass: opencode-bus-relay (PID 2857164).",
    source: "mac-launchd",
    host: "local-mac",
  },
  {
